...
class TTS:
    ...
    def __init__(
        ...
        if model_name is not None:
            if "tts_models" in model_name or "coqui_studio" in model_name:
                self.load_tts_model_by_name(model_name, gpu, output_path)
            elif "voice_conversion_models" in model_name:
                self.load_vc_model_by_name(model_name, gpu, output_path)
    ...
    def download_model_by_name(self, model_name: str, output_path: str = None):
        model_path, config_path, model_item = self.manager.download_model(model_name, output_path)
        ...
        vocoder_path, vocoder_config_path, _ = self.manager.download_model(model_item["default_vocoder"], output_path)
        return model_path, config_path, vocoder_path, vocoder_config_path, None

    def load_vc_model_by_name(self, model_name: str, gpu: bool = False, output_path: str = None):
        ...
        model_path, config_path, _, _, _ = self.download_model_by_name(model_name, output_path)
        self.voice_converter = Synthesizer(vc_checkpoint=model_path, vc_config=config_path, use_cuda=gpu)

    def load_tts_model_by_name(self, model_name: str, gpu: bool = False, output_path: str = None):
